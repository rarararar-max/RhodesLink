...
import com.example.rhodesterminal.shared.data.ChatRepository as SharedChatRepository
...
class ChatRepository(
    ...
    suspend fun bfsRelationGraph(centerId: String): List<com.example.rhodesterminal.shared.data.BfsNode> = shared.bfsRelationGraph(centerId)
    ...
    suspend fun getMessageCountPerSender(): List<com.example.rhodesterminal.shared.data.SenderCount> = shared.getMessageCountPerSender()
