...
- 没有特殊说明时，本轮至少一名成员自然发言；群聊规则、用户本轮明确要求或本轮成员回应方向要求更多成员时，以其为准。旁白不计入成员发言。
...
【发言规则】
 - 没有特殊说明时，本轮至少一名成员自然接话；群聊规则、用户本轮明确要求或本轮成员回应方向要求更多成员时，以其为准。
- 不要机械点名或轮流汇报。
...
- 可以有短暂的冷场和尴尬。真人群聊里，有人说了没人接话、有人发了个大家没get到的梗——这些瞬间反而让群聊更有生活感
 - 默认至少一名成员接话；需要多人回应时，台词长短、插话顺序和回应角度应有差异，避免机械轮流点名。
