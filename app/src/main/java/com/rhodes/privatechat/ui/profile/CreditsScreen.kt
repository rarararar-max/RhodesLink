...
fun CreditsScreen(
    ...
    Column(modifier = Modifier.fillMaxSize().background(BG).systemBarsPadding()) {
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(24.dp))
            HorizontalDivider(color = Color(0xFF3A3A3E))
            Text("版本 1.13.1", fontSize = 12.sp, color = Color(0xFF636366), modifier = Modifier.padding(bottom = 2.dp))
...
private fun SponsorSection() {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Spacer(modifier = Modifier.height(16.dp))
        Text("展示的数据来自：6月11日 - 8月15日", fontSize = 12.sp, color = TextSecondary, modifier = Modifier.padding(horizontal = 16.dp))
...
private val sponsors = listOf(
    Sponsor("西门寺幽幽子", "¥100.00", "QQ"), Sponsor("☙繁星❁✨", "¥100.00", "QQ"),
    ...
    Sponsor("爽食芭菲奈", "¥5.00", "QQ"), Sponsor("迟夏饮冰", "¥5.00", "QQ"), Sponsor("橘前辈", "¥5.00", "QQ"), Sponsor("TATOBA", "¥5.00", "QQ"),
    ...
    Sponsor("牢橘", "¥4.00", "QQ"), Sponsor("牢橘", "¥4.00", "QQ"), Sponsor("沐风游月", "¥3.00", "QQ"), Sponsor("TATOBA", "¥3.00", "QQ"), Sponsor("トロテム", "¥5.00", "QQ"), Sponsor("トロテム", "¥3.25", "QQ"), Sponsor("QQ转账", "¥5.00", "QQ"), Sponsor("亲亲羽毛笔(喻乐)", "¥10.00", "QQ"),
    ...
    Sponsor("**炜", "¥200.00", "支付宝"), Sponsor("**修", "¥10.00", "支付宝"),
