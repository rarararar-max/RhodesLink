...
fun applyRhodesDayTheme() {
    BG = Color(0xFFE7E9E8)
    Surface = Color(0xFFF4F5F2)
    Card = Color(0xFFFFFFFF)
    Divider = Color(0xFFB8BDBB)
    InputBg = Color(0xFFE1E4E1)
    TextPrimary = Color(0xFF1B2020)
    TextSecondary = Color(0xFF5D6664)
    TextTertiary = Color(0xFF818987)
    Primary = Color(0xFFD96700)
    PrimaryContainer = Color(0xFFFFE2C2)
    OnPrimary = Color.White
    SurfaceVariant = Color(0xFFE8EBE8)
    ErrorRed = Color(0xFFC83832)
    AccentGreen = Color(0xFF3E8064)
    AccentOrange = Color(0xFFD96700)
    AccentBlue = Color(0xFF1685B7)
    AccentPurple = Color(0xFF7155A5)
    Gray100 = Color(0xFFE8EBE8)
    Gray500 = Color(0xFF818987)
    Blue400 = Color(0xFF1685B7)
    NavBarBg = Color(0xFF232827)
    ElevatedSurface = Color(0xFFF9FAF7)
    Stroke = Color(0x261B2020)
    StrokeStrong = Color(0x4D1B2020)
    Glow = Color(0x26D96700)
    Scrim = Color(0x80000000)
    HeaderStart = Color(0xFFF9FAF7)
    HeaderEnd = Color(0xFFDCE1DD)
    BubbleMine = Color(0xFFFFE0BD)
    BubbleMineEnd = Color(0xFFF2BD78)
    BubbleOther = Color(0xFFF9FAF7)
    WarningContainer = Color(0xFFFFE4BF)
    SuccessContainer = Color(0xFFDCEEE4)
}

fun applyRhodesNightTheme() {
    BG = Color(0xFF15171C)
    Surface = Color(0xFF20242B)
    Card = Color(0xFF2A3039)
    Divider = Color(0xFF3B424C)
    InputBg = Color(0xFF292F38)
    TextPrimary = Color(0xFFE9ECE8)
    TextSecondary = Color(0xFFACB3B6)
    TextTertiary = Color(0xFF7B858B)
    Primary = Color(0xFFFF7800)
    PrimaryContainer = Color(0xFF55300F)
    OnPrimary = Color(0xFF171A1E)
    SurfaceVariant = Color(0xFF2A3039)
    ErrorRed = Color(0xFFFF625C)
    AccentGreen = Color(0xFF65B991)
    AccentOrange = Color(0xFFFF7800)
    AccentBlue = Color(0xFF48B7EC)
    AccentPurple = Color(0xFFAD91E0)
    Gray100 = Color(0xFF292F38)
    Gray500 = Color(0xFF7B858B)
    Blue400 = Color(0xFF48B7EC)
    NavBarBg = Color(0xFF15171C)
    ElevatedSurface = Color(0xFF252B33)
    Stroke = Color(0x2EFFFFFF)
    StrokeStrong = Color(0x4AFFFFFF)
    Glow = Color(0x24FF7800)
    Scrim = Color(0xAA000000)
    HeaderStart = Color(0xFF292F38)
    HeaderEnd = Color(0xFF15171C)
    BubbleMine = Color(0xFF64350E)
    BubbleMineEnd = Color(0xFF9A500C)
    BubbleOther = Color(0xFF2A3039)
    WarningContainer = Color(0xFF513314)
    SuccessContainer = Color(0xFF1F4235)
}
